...
Olakšava navigaciju – Intuitivna sučelja osiguravaju da korisnici mogu brzo i učinkovito pronaći što trebaju.
Jača branding – Jak UI/UX pojačava identitet branda i kredibilitet.
Poboljšava stope konverzije – Besprijekorno iskustvo potiče korisnike na željene radnje, poput registracije ili kupnje.
Pomaže sa SEO-om – Dobro strukturirane, user-friendly stranice rangiraju bolje u tražilicama.
Poboljšava brzinu web stranice – Optimizirani UX/UI smanjuje vrijeme učitavanja, poboljšavajući performanse.
Smanjuje potrebu za korisničkom podrškom – Jasan dizajn minimizira zbunjenost, smanjujući zahtjeve za podršku.
Poboljšava korisničko iskustvo – Glatka, ugodna interakcija povećava zadovoljstvo korisnika.
Daje konkurentsku prednost – Superioran UI/UX čini da proizvod ističe se na prepunom tržištu."Pokaži slajd s 10 benefit kutijaŠto reći studentima (prođi kroz sve benefite - 8 min):"Zašto kompanije investiraju u dobar UX/UI design? Evo 10 razloga:"1️⃣ Privlačenje i zadržavanje kupaca (Customer Acquisition & Retention)
...
Desno (narančasto): UI
Što reći studentima (8 min):"Hajmo detaljnije vidjeti što svaki dizajner radi:"🔷 UX DESIGNER RADI:Market Research - Razumijevanje industrije i potreba korisnika
...
Functionality - Osiguravanje da funkcionalnosti rade kako treba🔶 UI DESIGNER RADI:Color - Postavljanje raspoloženja, isticanje elemenata, identitet branda
...
High Fidelity - Detaljni, uglađeni mockupi blizu konačnom dizajnu🟣 OBA RADE (Preklapanje):Collaboration - Rad u timu za bolje korisničko iskustvo
...
Opseg – Određuje što će proizvod uključivati i kako će funkcionirati. Uključuje definiranje funkcionalnosti, zahtjeva za sadržaj i osiguravanje da sve radi zajedno kako bi pružilo besprijekorno iskustvo bez preopterećenja korisnika.
Struktura – Fokusira se na interaction design i informacijsku arhitekturu. Osigurava da korisnici mogu intuitivno navigirati proizvodom organiziranjem sadržaja i interakcija logično.
Kostur – Vizualni nacrt, uključujući wireframe i prototipe, koji definira smještaj elemenata sučelja poput buttona, slika i teksta. Cilj je stvoriti intuitivan layout s kojim korisnici mogu bez napora interaktirati.
Površina – Konačni sloj, gdje vizualni elementi dizajna poput tipografije, boje i slikovnosti dolaze do izražaja. Ova faza poboljšava senzorno iskustvo i osigurava ravnotežu između estetike i funkcionalnosti za privlačno korisničko iskustvo.
Svaki sloj gradi na prethodnom, stvarajući user-friendly i vizualno privlačan proizvod."_Pokaži dijagram: Iceberg model s 5 razinaŠto reći studentima (12 min):"James Garrett je kreirao model od 5 razina UX designa. Ovo pomaže dekonstruirati proces - idemo korak-po-korak, od osnove do detalja."Zašto ovaj model?
...
Objasni svaku razinu (bottom-up):1️⃣ STRATEGY (STRATEGIJA - najdublja razina, temelj)Što je:
...
Skeleton (gdje stavljamo elemente)
  ↓
Surface (kako izgleda)Analogija (kuća):
...
Istraživanje – Također se zove Discovery faza, varira po dubini ovisno o projektu. Uključuje istraživanje korisnika i konkurencije kako bi informiralo proces dizajniranja, ali se često preskače u Lean UX pristupima.
Analiza – Izvlači uvide iz podataka istraživanja kako bi razumjela potrebe korisnika i validirala pretpostavke.
Dizajn – Suradnički i iterativni proces gdje se ideje testiraju s korisnicima kroz low-fidelity prototipove.
Produkcija – Finalizira high-fidelity dizajne, stvara digitalne resurse i blisko radi s developerima kako bi implementirao i validirao proizvod.
Dok ove faze nalikuju linearnom waterfall modelu, UX dizajn je inherentno iterativan, zahtijevajući konstantan feedback, revizije i komunikaciju sa stakeholderima. Ovo se slaže s Agile razvojem i Lean Startup principima, osiguravajući kontinuirano poboljšanje temeljeno na inputu korisnika. Efektivna komunikacija je ključna za osiguravanje buy-ina stakeholdera i uspjeha projekta."_Pokaži dijagram: Kružni UX procesŠto reći studentima (12 min):"Sada kada razumijemo 5 Levels (James Garrett model), pogledajmo UX proces - kako zapravo radimo UX design u praksi."UX proces ima 5 faza:1️⃣ STRATEGY (STRATEGIJA)Što je:
...
Project brief
Kriteriji uspjeha
2️⃣ RESEARCH (ISTRAŽIVANJE - Discovery faza)Što je:
...
Testirani dizajni
5️⃣ PRODUCTION (PRODUKCIJA)Što je:
...
Biblioteka resursa
⚠️ KRITIČNO - Proces NIJE linearan!Prikazuje se kao waterfall (1→2→3→4→5), ALI:
...
Strategija → Istraživanje → Analiza → Dizajn
                ...
                ← ← ← Test ← ← ← ← ←
                   ...
                   Mjerenje i učenje
                         ↓
                   Natrag na Strategiju!Agile i Lean UX:
...
✅ Case study prezentacija: 10-15 slajdovaEVALUACIJA:30% - Istraživanje i proces
...
Figma Interface Tour (10 min):1. FILE BROWSER (2 min)"Prvo što vidite je file browser - ovdje su svi vaši Figma fajlovi."

Kao Google Drive za dizajn
Možete organizirati u foldere
Drafts - gdje su vaši osobni fajlovi
"Kliknite New Design File da kreiramo novi fajl."2. FIGMA INTERFACE - 4 glavna dijela (8 min)Pokaži na svom ekranu (projektor):A) TOP TOOLBAR (2 min)"Gore na vrhu imate toolbar s alatima:"Lijevo:
...
B) LEFT PANEL - Layers (2 min)"S lijeve strane je Layers panel:"

Prikazuje sve objekte na vašem canvasu
Hierarchy struktura - parent → child odnosi
Kao "slojevi" u Photoshopu
"Ne brinite o ovome sada, koristit ćemo kasnije."C) CANVAS - Center (1 min)"U sredini je Canvas - radna površina:"
...
Basic Tools Demo (10 min):"Hajmo probati osnovne alate!"1. FRAME TOOL (F) - 2 min"Frame je kontejner za dizajn - kao 'artboard' u drugim alatima."Demonstriraj:
...
Pritisni R (ili klikni Rectangle u toolbaru)
Drag unutar framea = kreira se rectangle
...
"Buttoni su uglavnom samo rectanglesi sa zaobljenim uglovima + tekst!"3. TEXT TOOL (T) - 2 min"Text tool - za dodavanje teksta."Demonstriraj:

Pritisni T
Klikni bilo gdje u frameu
Upiši: "Dobrodošli!"
U right panel, promijeni:
...
4. MOVE TOOL (V) - 2 min"Move tool - za selektiranje i micanje objekata."Demonstriraj:

Pritisni V (ili ESC)
Klikni na rectangle ili tekst = selektiraš ga
Drag = pomičeš ga
Drag corner handles = resiziraš ga
Shift + Drag = pomiče se perfectly horizontal/vertical
5. ZOOM & PAN (1 min)"Navigacija po canvasu:"
...
Keyboard Shortcuts (3 min - napiši na ploču):"Evo prečaca koje morate znati:"Alati:
...
Što je User Interface (UI)?
Koja je glavna razlika između UX i UI designa?
Navedite 3 benefita dobrog UI/UX designa
Koje su 5 razina User Experience (James Garrett)?
...
Možeš koristiti: https://www.webpagesthatsuck.com/ za gotove primjere
...
Zadatak: Brainstorm 3 ideje za projekt (5 min)
...
Možeš pokazati: https://userinyerface.com/ - намjerno loš UX
...
Grupna aktivnost: Na papiru, skicirajte kako bi poboljšali dizajn (10 min)

Fokus na 3 glavna poboljšanja
Brze skice, ne mora biti fancy


Dijeljenje: 2-3 grupe pokazuju svoje skice (1 min svaka)
...
Loš dizajn: https://www.arngren.net/
Ili bilo koja pretrpana lokalna web stranica
...
Jedna studentica iz svakog tima dolazi naprijed
Facilitator šapne UX termin (npr. "user journey", "wireframe", "prototype")
Studentica mora nacrtati termin na ploči (1 min)
Njen tim pokušava pogoditi termin
Tim koji prvi pogodi dobiva bod
